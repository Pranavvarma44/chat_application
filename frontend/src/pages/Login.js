    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-purple-900">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          <input
            placeholder="Email"
            className="w-full px-4 py-2 rounded-lg bg-black/30 border border-white/10 focus:ring-2 focus:ring-purple-500"
          ...
          <button
            onClick={login}
            className="w-full bg-purple-500 hover:bg-purple-600 py-2 rounded-lg transition"
          >
            Login
          </button>
        </div>
